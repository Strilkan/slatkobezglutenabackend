...
export interface ApiKategorijaKategorija extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Tip: Schema.Attribute.Enumeration<['slatko', 'slano']> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiKontaktKontakt extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    Naslov: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Kontaktirajte nas'>;
...
export interface ApiPutovanjaPutovanja extends Struct.CollectionTypeSchema {
  collectionName: 'putovanjas';
  info: {
    displayName: 'Putovanja';
    pluralName: 'putovanjas';
    singularName: 'putovanja';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    Fotografija: Schema.Attribute.Media<
...
export interface ApiReceptRecept extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Datum: Schema.Attribute.DateTime;
    Istaknuto: Schema.Attribute.Boolean;
    Kategorijas: Schema.Attribute.Relation<
      'manyToOne',
      'api::kategorija.kategorija'
    >;
    KratkiOpis: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::recept.recept'
    ...
    Naslov: Schema.Attribute.String;
    Opis: Schema.Attribute.RichText;
    Priprema: Schema.Attribute.RichText;
    publishedAt: Schema.Attribute.DateTime;
    Sastojci: Schema.Attribute.RichText;
    Slika: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    Slug: Schema.Attribute.UID<'Naslov'>;
    Tip: Schema.Attribute.Enumeration<['slano', 'slatko']> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::putovanja.putovanja': ApiPutovanjaPutovanja;
